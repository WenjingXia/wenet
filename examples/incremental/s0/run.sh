...
src_dir=/ssd/wenjing.xia/AISHELL-2
src_dir=/data/wenjing.xia/data/AISHELL-2
trn_set=${src_dir}/AISHELL-2/iOS/data
dev_set=${src_dir}/AISHELL-DEV-TEST-SET/iOS/dev
tst_set=${src_dir}/AISHELL-DEV-TEST-SET/iOS/test
...
train_config=conf/train_incremental.yaml
cmvn=true
dir=exp/conformer_incremental
checkpoint=exp/pre_train.pt

teacher_checkpoint=exp/pre_train.pt
