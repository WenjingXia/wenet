...
if __name__ == '__main__':
    ...
    if args.teacher:
        teacher_model = init_asr_model(configs)
    ...
    if distributed:
        ...
        if args.teacher:
            ...
            #    teacher_model, find_unused_parameters=True)
    ...
    criterion = Loss(vocab_size=vocab_size, device=device, teacher=args.teacher, **configs['loss_conf'])
